...
teórico individual e desenvolvimento social geral''.\footnote{``O
  ...
  formam uma unidade necessária, todo o processo, porém, transcorre --- %necessária, mas todo o processo transcorre
  de modo algum contingente --- em um período da história alemã, no qual % trecho entre traços depois de "processo"?
  --- após a ascensão ao trono de Frederico Guilherme \textsc{iv} na
  Prússia, após a conversão reacionário"-romântica da política interna %tentar não repetir o "após" de alguma forma. Talvez "após [...], e [...]"
...
já que a rubrica \emph{marxismo} serve justamente para diferenciar dos %"para diferenciá"-lo" ou "para estabelecer diferenciação"
...
do \emph{Standpunkt} europeu em uma de suas figuras centrais, o avanço %em uma de suas formas centrais?
do poder do ``mercado mundial'', torna"-se inquestionável no século %e talvez também: "em uma de suas figuras centrais --- [a saber,] o avanço do poder do ``mercado mundial'' ---"
...
\emph{caráter natural}\footnote{Citar o Kant: ``Devido ao fato da %este "citar o Kant" se mantém?
...
seriam históricas, necessariamente transitórias: ``Havia assim %passagem confusa. Se entendi bem, talvez colocar "enquanto que as instituições feudais [...]"
...
movimento concreto, basta atentar, por exemplo, para a cisão entre %bastando? Ou "concreto; basta atentar..."
...
que somente poderia ser ``apreendida (\emph{abgefasst}) se produz %se produzir, à medida que produz
...
diferentes dos queridos --- \emph{muitas vezes contrapostos} --- e que, %diferentes dos desejados
...
%!!!ao revisor: substituir de acordo com a versão final do parágrafo!!!
...
produzem resultados totalmente diferentes dos queridos --- \emph{muitas %diferentes dos desejados
...
assalariada) e as circunstâncias, mesmo se pensarmos na ``cisão entre o %e as circunstâncias da acumulação originária (primitiva) --- mesmo se pensarmos na ``cisão entre o trabalhador e a \emph{propriedade} das condições de efetivação de seu trabalho'' ---, já que...
...
impulsos violentos que geram a cisão (\emph{Trennung}), entre eles, por %fiquei na dúvida sobre a vírgula após o parêntese
...
\begin{quote}
Com Hegel encerrasse a filosofia em geral. Por um lado, porque ele %primeiro período da citação está confuso. Talvez contextualizá-lo (o quê com Hegel) usando colchetes?
...
em si'' até que a química orgânica as ter começado a apresentar uma após %as começou a apresentar?
...
denominadas \emph{Geistwissenschaften} escapará dessa relação, que %nota traduzindo o termo?
...
Partindo do sistema de cooperação artesanal capitalista, passando pela %período não parece concluir-se
...
subemitido à mesma concorrência, imposição e pressão dos interesses que %submetido?
...
``armas'' da história da filosofia, do direito ou da economia, mas da %e sim da?
