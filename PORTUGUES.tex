...
\footnotetext{{[}N.T.{]} ENGELS, F. \emph{Werke.
...
O presente escrito \footnote{{[}N. E.{]} Ludwig Feuerbach, de C.
  N. Starcke, Dr. Phil. Stuttgart, Ferd. Encke, 1885.}
...
Assim como na França do século XVIII, também na Alemanha do século XIX,
...
necessidade''\footnote{{[}N.T.{]} \emph{Enzyklopädie
  ...
  (grifei)}um regulamento governamental arbitrário - o próprio Hegel
...
que Frederico Guilherme III tão obstinadamente em vão prometeu aos seus súditos,
...
``Único''. \footnote{{[}N.T.{]} Max Stirner.
...
constituição corporal e incitados por aparições no sonho\footnote{{[}N.E.{]}
  ...
  isso se encontrou, em 1884, entre os índios na Guiana.},
...
kantiana é tentada na Alemanha pelos neokantianos\footnote{{[}N.T.{]} O
...
Inglaterra (onde nunca morreu) pelos agnósticos \footnote{{[}N.T.{]} A
...
religion}!\footnote{{[}N.T.{]} ``Portanto,
...
fornecidos por Kopp e Berthelot comprovam.\footnote{{[}N.T.{]} A relação
  ...
  ``\emph{Les origines de l´alchimie}'', 1885.}
...
sabemos como Robespierre\footnote{{[}N.T.{]}
...
incógnita}''.\footnote{{[}N.T.{]} Starcke: Ludwig Feuerbach, 1ª edição, p. 280.}
...
homem, da cultura, da história''\footnote{{[}N.T.{]}
...
é o próprio ``mestre-escola de Sadowa''\footnote{{[}N.T.{]} Possivelmente uma referência à Batalha de
...
da \emph{Dogmática} \footnote{{[}N.T.{]}
...
essencialmente ao nome de Marx. \footnote{{[}N.E.{]}
...
Hegel,
por um trabalhador
alemão, Josef Dietzgen.\footnote{{[}N.E.{]} Cfr. ``\emph{Das Wesen der Kopfarbeit,
...
(\emph{Landrecht} prussiano) \footnote{{[}N.T.{]}
...
lutas no interior da república romana, apenas Apiano
\footnote{{[}N.T.{]} Apiano de Alexandria, autor da \emph{História
  romana} (\emph{Ῥωμαϊκά - Romaica}) escrita em 24 volumes.} nos diz
...
de Niceia.\footnote{{[}N.T.{]} Primeiro
...
da França, entre os Albigenses \footnote{{[}N.T.{]} Os Albigenses
  ...
  ao controle de terra pela Igreja e a hierarquia eclesiástica.}, na
...
libertava a Holanda da Espanha e do Império alemão\footnote{{[}N.T.{]}
  ...
  entre 1477 e 1555.} e fornecia o
...
1685\footnote{{[}N.T.{]} Fim do Édito de
...
nascia Voltaire.
A medida violenta
de Luís XIV apenas facilitou à burguesia francesa para que pudesse fazer a sua
