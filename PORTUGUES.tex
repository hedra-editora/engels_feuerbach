...
explicitou em um estágio histórico determinado, ǁ no século \versal{XVIII} ǁ.\est\
...
filosofia, política, prática do direito (\emph{Jurisprudenz}){[}.{]}\endnote{Engels já havia indicado isso em um artigo publicado na \emph{Nova
...
(\emph{theoretisch"-rücksichtslose}):\endnote{Aqui é
