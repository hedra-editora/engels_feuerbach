...
\footnotetext{ENGELS, F. \emph{Werke.
...
fiscal''\footnote{\emph{Enzyklopädie der philosophischen Wissenschaften I,} § 142,
...
religião'' etc.\footnote{FEUERBACH, L. ``\emph{Grundsätze der Philosophie. Nothwendigkeit einer Veränderung. 1842/43}''. IN: \emph{Ludwig Feuerbach in seinem
...
homem, da cultura, da história'',\footnote{FEUERBACH, L. ``Fragmente zur Characteritik meines philosophischen
...
filosofia, política, prática do direito (\emph{Jurisprudenz}){[}.{]}\footnote{Engels já havia indicado isso em um artigo publicado na \emph{Nova
  ...
  {[}A guerra camponesa alemã{]}. IN: MEGA, I.10. {[}\versal{N.\,T.}{]}} Tinha-as
...
(\emph{theoretisch-rücksichtslose}):\footnote{Aqui é
  ...
  Band 1. Berlin/DDR: Dietz Verlag, 1976, p. 344. {[}\versal{N.\,T.}{]}} ecletismo desprovido
